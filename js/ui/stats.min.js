...
var Stats=function(){
    ...
    c.style.cssText="position:fixed;top:64px;left:0;cursor:pointer;opacity:0.9;z-index:10000";
...
k(0);
return{REVISION:16,dom:c,addPanel:h,showPanel:k,begin:function(){
...
Stats.Panel=function(h,k,l){
    ...
    b.globalAlpha=.9;
    b.fillRect(d,m,n,p);
    return{dom:q,update:function(f,v){
        c=Math.min(c,f);
        g=Math.max(g,f);
        b.fillStyle=l;
        b.globalAlpha=1;
